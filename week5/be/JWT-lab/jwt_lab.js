...
function decodeJWT(token) {
  ...
  const jwtToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEyMywidXNlcm5hbWUiOiJleGFtcGxlVXNlciIsImlhdCI6MTcwMDcyOTAyMn0.rFtxGkD9jKThgVACCks_Dzm-m9plwFyRPTEPknZJW0E';
...
function verifyJWT(token) {
  ...
  // Replace 'yourTokenHere' with a JWT token you generated in Step 4
  const jwtTokenToVerify = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEyMywidXNlcm5hbWUiOiJleGFtcGxlVXNlciIsImlhdCI6MTcwMDcyOTAyMn0.rFtxGkD9jKThgVACCks_Dzm-m9plwFyRPTEPknZJW0E';
